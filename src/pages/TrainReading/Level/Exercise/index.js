...
const Exercise = () => {
  ...
  const lpmFromPushup = 12 // pushup.state.nevigateObject.lpm // i have to take the info from pushup by navigateObj

  const BookName = " Harry Potter "  // pushup.state.nevigateObject.bookName //i have to take the info from pushup by navigateObj
  ...
  const objProps = { LPM: lpmFromPushup }
